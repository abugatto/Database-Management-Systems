...
enum COMMAND {READ, USE, CREATE_DB, CREATE_TB, DROP_DB, DROP_TB, INSERT, SELECT, UPDATE, DELETE, ALTER, EXIT};
...
class DBMS {
	public:
		...
		bool usingShell();
		void dbmsShell();
		void runDBMS(); //runs after every shell command (USE Pthreads here)
